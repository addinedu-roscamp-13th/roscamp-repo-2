...
static const Golden GOLDEN[] = {
    {"화장실",         0.7518, -0.3615, 0.2546, 0.1810},
    {"수거함",         0.7518, -1.0010, 0.5457, 0.1810},
    {"예술서가",        0.3000, -0.3615, 0.2546, 0.5585},
    {"문학서가",        0.0263, -0.3615, 0.2546, 0.7871},
    {"과학-인문학서가",  0.3000, -0.6600, 0.3905, 0.5585},
    {"도서관출입구",     0.3000, -1.7040, 0.8656, 0.5585},
    {"안네데스크",      0.0263, -1.7040, 0.8656, 0.7871},
    // sim 실측 pose. 이 값이 그림 어디에 찍히는지 눈으로 확인한 자리다(스크린샷 검증됨).
    {"sim 실측 pose",   0.6105, -0.4116, 0.2776, 0.2995},
};
