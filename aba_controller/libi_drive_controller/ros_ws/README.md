...
Executed from `/home/robotPrj/controller/ros_ws`.

```bash
cd /home/robotPrj/controller/ros_ws
...
```text
AMENT_PREFIX_PATH includes /home/robotPrj/controller/ros_ws/install packages and /opt/ros/jazzy.
