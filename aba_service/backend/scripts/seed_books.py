"""Drop and re-seed the `cb_books` table with a curated catalog across five
fields: 문학(literature) · 예술(art) · 과학(science) · 인문학(humanities) · 유아(kids).
...
BOOKS = [
    ...
    B({"KR": "데미안", "EN": "Demian", "ZH": "德米安", "VI": "Demian"}, "헤르만 헤세",
      "literature", "🕊️", "from-rose-200 to-rose-300", "문학-1", "첫째 줄", True,
    ...
    B({"KR": "1984", "EN": "1984", "ZH": "一九八四", "VI": "1984"}, "조지 오웰",
      "literature", "🌃", "from-slate-200 to-slate-300", "문학-1", "둘째 줄", True,
    ...
    B({"KR": "노인과 바다", "EN": "The Old Man and the Sea", "ZH": "老人与海", "VI": "Ông già và biển cả"}, "어니스트 헤밍웨이",
      "literature", "🐟", "from-sky-200 to-blue-300", "문학-1", "첫째 줄", True,
    ...
    B({"KR": "위대한 개츠비", "EN": "The Great Gatsby", "ZH": "了不起的盖茨比", "VI": "Đại gia Gatsby"}, "F. 스콧 피츠제럴드",
      "literature", "🥂", "from-amber-200 to-yellow-300", "문학-1", "둘째 줄", False,
    ...
    B({"KR": "어린 왕자", "EN": "The Little Prince", "ZH": "小王子", "VI": "Hoàng tử bé"}, "생텍쥐페리",
      "literature", "🌹", "from-yellow-200 to-amber-300", "문학-1", "첫째 줄", True,
    ...
    B({"KR": "죄와 벌", "EN": "Crime and Punishment", "ZH": "罪与罚", "VI": "Tội ác và trừng phạt"}, "도스토옙스키",
      "literature", "🪓", "from-stone-200 to-stone-300", "문학-1", "둘째 줄", True,
    ...
    B({"KR": "변신", "EN": "The Metamorphosis", "ZH": "变形记", "VI": "Hóa thân"}, "프란츠 카프카",
      "literature", "🪲", "from-lime-200 to-emerald-300", "문학-1", "첫째 줄", True,
    ...
    B({"KR": "햄릿", "EN": "Hamlet", "ZH": "哈姆雷特", "VI": "Hamlet"}, "윌리엄 셰익스피어",
      "literature", "💀", "from-indigo-200 to-slate-300", "문학-1", "둘째 줄", True,
    ...
    B({"KR": "서양미술사", "EN": "The Story of Art", "ZH": "艺术的故事", "VI": "Câu chuyện nghệ thuật"}, "E.H. 곰브리치",
      "art", "🖼️", "from-amber-200 to-orange-300", "예술-1", "첫째 줄", True,
    ...
    B({"KR": "다른 방식으로 보기", "EN": "Ways of Seeing", "ZH": "观看之道", "VI": "Các phương cách nhìn"}, "존 버거",
      "art", "👁️", "from-rose-200 to-pink-300", "예술-1", "둘째 줄", True,
    ...
    B({"KR": "반 고흐, 영혼의 편지", "EN": "The Letters of Vincent van Gogh", "ZH": "梵高手稿", "VI": "Những lá thư của Van Gogh"}, "빈센트 반 고흐",
      "art", "🌻", "from-yellow-200 to-amber-300", "예술-1", "첫째 줄", True,
    ...
    B({"KR": "카메라 루시다", "EN": "Camera Lucida", "ZH": "明室", "VI": "Buồng sáng"}, "롤랑 바르트",
      "art", "📷", "from-zinc-200 to-slate-300", "예술-1", "둘째 줄", False,
    ...
    B({"KR": "디자인의 디자인", "EN": "Designing Design", "ZH": "设计中的设计", "VI": "Thiết kế của thiết kế"}, "하라 켄야",
      "art", "✏️", "from-neutral-200 to-stone-300", "예술-1", "첫째 줄", True,
    ...
    B({"KR": "색채의 예술", "EN": "The Art of Color", "ZH": "色彩艺术", "VI": "Nghệ thuật màu sắc"}, "요하네스 이텐",
      "art", "🌈", "from-fuchsia-200 to-purple-300", "예술-1", "둘째 줄", True,
    ...
    B({"KR": "미학 오디세이", "EN": "Aesthetics Odyssey", "ZH": "美学奥德赛", "VI": "Hành trình mỹ học"}, "진중권",
      "art", "🎭", "from-violet-200 to-indigo-300", "예술-1", "셋째 줄", True,
    ...
    B({"KR": "코스모스", "EN": "Cosmos", "ZH": "宇宙", "VI": "Vũ trụ"}, "칼 세이건",
      "science", "🌌", "from-indigo-300 to-purple-400", "과학-1", "첫째 줄", True,
    ...
    B({"KR": "이기적 유전자", "EN": "The Selfish Gene", "ZH": "自私的基因", "VI": "Gen vị kỷ"}, "리처드 도킨스",
      "science", "🧬", "from-emerald-200 to-teal-300", "과학-1", "둘째 줄", True,
    ...
    B({"KR": "시간의 역사", "EN": "A Brief History of Time", "ZH": "时间简史", "VI": "Lược sử thời gian"}, "스티븐 호킹",
      "science", "⏳", "from-slate-300 to-zinc-400", "과학-1", "첫째 줄", True,
    ...
    B({"KR": "종의 기원", "EN": "On the Origin of Species", "ZH": "物种起源", "VI": "Nguồn gốc các loài"}, "찰스 다윈",
      "science", "🐒", "from-amber-200 to-lime-300", "과학-1", "둘째 줄", False,
    ...
    B({"KR": "사피엔스", "EN": "Sapiens", "ZH": "人类简史", "VI": "Sapiens: Lược sử loài người"}, "유발 하라리",
      "humanities", "🧠", "from-orange-200 to-red-300", "인문학-1", "첫째 줄", True,
    ...
    B({"KR": "페르마의 마지막 정리", "EN": "Fermat's Last Theorem", "ZH": "费马大定理", "VI": "Định lý cuối cùng của Fermat"}, "사이먼 싱",
      "science", "♾️", "from-sky-200 to-indigo-300", "과학-1", "둘째 줄", True,
    ...
    B({"KR": "침묵의 봄", "EN": "Silent Spring", "ZH": "寂静的春天", "VI": "Mùa xuân vắng lặng"}, "레이첼 카슨",
      "science", "🌿", "from-green-200 to-emerald-300", "과학-1", "셋째 줄", True,
    ...
    B({"KR": "부분과 전체", "EN": "Physics and Beyond", "ZH": "部分与整体", "VI": "Phần và toàn thể"}, "베르너 하이젠베르크",
      "science", "⚛️", "from-cyan-200 to-blue-300", "과학-1", "셋째 줄", True,
    ...
    # ───────────────────────── 문학 (literature) · 문학-1 (추가) ─────────────────────────
    B({"KR": "채식주의자", "EN": "The Vegetarian", "ZH": "素食者", "VI": "Người ăn chay"}, "한강",
      "literature", "🥬", "from-lime-200 to-green-300", "문학-1", "다섯째 줄", True,
      {"KR": "육식을 거부하며 나무가 되려는 여자를 통해 욕망과 폭력을 파고든 한강의 장편.",
       "EN": "Han Kang's novel of a woman who refuses meat and longs to become a tree.",
       "ZH": "韩江描写拒绝肉食、渴望成为树木的女子的长篇小说。",
       "VI": "Tiểu thuyết của Han Kang về người phụ nữ từ chối ăn thịt và khát khao hóa thành cây."},
      {"KR": ["#한강", "#노벨문학상", "#한국소설"], "EN": ["#han-kang", "#nobel", "#korean-lit"],
       "ZH": ["#韩江", "#诺贝尔", "#韩国文学"], "VI": ["#han-kang", "#nobel", "#văn-học-hàn"]}),

    # ───────────────────────── 인문학 (humanities) · 인문학-1 ─────────────────────────
    # (사피엔스도 humanities로 분류됨 — 위 과학 섹션 위치에 그대로 둠)
    B({"KR": "총, 균, 쇠", "EN": "Guns, Germs, and Steel", "ZH": "枪炮、病菌与钢铁", "VI": "Súng, vi trùng và thép"}, "재레드 다이아몬드",
      "humanities", "🌍", "from-amber-200 to-orange-300", "인문학-1", "첫째 줄", True,
    ...
    # ───────────────────────── 유아 (kids) · 유아 ─────────────────────────
    B({"KR": "배고픈 애벌레", "EN": "The Very Hungry Caterpillar", "ZH": "好饿的毛毛虫", "VI": "Chú sâu háu ăn"}, "에릭 칼",
      "kids", "🐛", "from-lime-200 to-green-300", "유아", "첫째 줄", True,
      {"KR": "먹으며 자라 나비가 되는 애벌레로 요일과 숫자를 배우는 그림책의 고전.",
       "EN": "A picture-book classic: a caterpillar eats, grows and becomes a butterfly.",
       "ZH": "毛毛虫边吃边长、最终化蝶的经典图画书。",
       "VI": "Sách tranh kinh điển: chú sâu ăn, lớn lên và hóa thành bướm."},
      {"KR": ["#그림책", "#유아", "#에릭칼"], "EN": ["#picture-book", "#kids", "#eric-carle"],
       "ZH": ["#图画书", "#幼儿", "#艾瑞卡尔"], "VI": ["#sách-tranh", "#thiếu-nhi", "#eric-carle"]}),

    B({"KR": "구름빵", "EN": "Cloud Bread", "ZH": "云朵面包", "VI": "Bánh mì mây"}, "백희나",
      "kids", "☁️", "from-sky-200 to-blue-300", "유아", "둘째 줄", True,
      {"KR": "구름으로 만든 빵을 먹고 하늘을 나는 남매의 따뜻한 그림책.",
       "EN": "A warm picture book about siblings who eat cloud bread and fly.",
       "ZH": "兄妹俩吃了云朵面包飞上天空的温馨图画书。",
       "VI": "Sách tranh ấm áp về hai anh em ăn bánh mì mây và bay lên trời."},
      {"KR": ["#그림책", "#백희나", "#상상력"], "EN": ["#picture-book", "#baek-heena", "#imagination"],
       "ZH": ["#图画书", "#白希那", "#想象力"], "VI": ["#sách-tranh", "#baek-heena", "#tưởng-tượng"]}),
]
