...
BOOKS = [
    ...
    B({"KR": "데미안", "EN": "Demian", "ZH": "德米安", "VI": "Demian"}, "헤르만 헤세",
      "literature", "🕊️", "from-rose-200 to-rose-300", "문학-1", "셋째 줄", True,
    ...
    B({"KR": "노인과 바다", "EN": "The Old Man and the Sea", "ZH": "老人与海", "VI": "Ông già và biển cả"}, "어니스트 헤밍웨이",
      "literature", "🐟", "from-sky-200 to-blue-300", "문학-1", "셋째 줄", True,
    ...
    B({"KR": "어린 왕자", "EN": "The Little Prince", "ZH": "小王子", "VI": "Hoàng tử bé"}, "생텍쥐페리",
      "literature", "🌹", "from-yellow-200 to-amber-300", "문학-1", "셋째 줄", True,
    ...
    B({"KR": "서양미술사", "EN": "The Story of Art", "ZH": "艺术的故事", "VI": "Câu chuyện nghệ thuật"}, "E.H. 곰브리치",
      "art", "🖼️", "from-amber-200 to-orange-300", "예술-1", "셋째 줄", True,
    ...
    B({"KR": "다른 방식으로 보기", "EN": "Ways of Seeing", "ZH": "观看之道", "VI": "Các phương cách nhìn"}, "존 버거",
      "art", "👁️", "from-rose-200 to-pink-300", "예술-1", "셋째 줄", True,
    ...
    B({"KR": "반 고흐, 영혼의 편지", "EN": "The Letters of Vincent van Gogh", "ZH": "梵高手稿", "VI": "Những lá thư của Van Gogh"}, "빈센트 반 고흐",
      "art", "🌻", "from-yellow-200 to-amber-300", "예술-1", "셋째 줄", True,
    ...
    B({"KR": "코스모스", "EN": "Cosmos", "ZH": "宇宙", "VI": "Vũ trụ"}, "칼 세이건",
      "science", "🌌", "from-indigo-300 to-purple-400", "과학-1", "셋째 줄", True,
    ...
    B({"KR": "이기적 유전자", "EN": "The Selfish Gene", "ZH": "自私的基因", "VI": "Gen vị kỷ"}, "리처드 도킨스",
      "science", "🧬", "from-emerald-200 to-teal-300", "과학-1", "셋째 줄", True,
    ...
    B({"KR": "시간의 역사", "EN": "A Brief History of Time", "ZH": "时间简史", "VI": "Lược sử thời gian"}, "스티븐 호킹",
      "science", "⏳", "from-slate-300 to-zinc-400", "과학-1", "셋째 줄", True,
    ...
    B({"KR": "사피엔스", "EN": "Sapiens", "ZH": "人类简史", "VI": "Sapiens: Lược sử loài người"}, "유발 하라리",
      "humanities", "🧠", "from-orange-200 to-red-300", "인문학-1", "셋째 줄", True,
    ...
    B({"KR": "총, 균, 쇠", "EN": "Guns, Germs, and Steel", "ZH": "枪炮、病菌与钢铁", "VI": "Súng, vi trùng và thép"}, "재레드 다이아몬드",
      "humanities", "🌍", "from-amber-200 to-orange-300", "인문학-1", "셋째 줄", True,
    ...
    B({"KR": "정의란 무엇인가", "EN": "Justice: What's the Right Thing to Do?", "ZH": "公正：该如何做是好", "VI": "Phải trái đúng sai"}, "마이클 샌델",
      "humanities", "⚖️", "from-blue-200 to-indigo-300", "인문학-1", "셋째 줄", True,
    ...
    B({"KR": "배고픈 애벌레", "EN": "The Very Hungry Caterpillar", "ZH": "好饿的毛毛虫", "VI": "Chú sâu háu ăn"}, "에릭 칼",
      "kids", "🐛", "from-lime-200 to-green-300", "유아", "셋째 줄", True,
    ...
    B({"KR": "구름빵", "EN": "Cloud Bread", "ZH": "云朵面包", "VI": "Bánh mì mây"}, "백희나",
      "kids", "☁️", "from-sky-200 to-blue-300", "유아", "셋째 줄", True,
    ...
    B({"KR": "무지개 물고기", "EN": "The Rainbow Fish", "ZH": "彩虹鱼", "VI": "Cá cầu vồng"}, "마르쿠스 피스터",
      "kids", "🐠", "from-cyan-200 to-blue-300", "유아", "셋째 줄", True,
      {"KR": "반짝이는 비늘을 나눠주며 진정한 우정을 배우는 물고기의 그림책.",
       "EN": "A picture book about a fish who learns true friendship by sharing its shiny scales.",
       "ZH": "分享闪亮鳞片、学会真正友谊的鱼儿图画书。",
       "VI": "Sách tranh về chú cá học được tình bạn chân thành khi chia sẻ vảy lấp lánh."},
      {"KR": ["#그림책", "#우정", "#나눔"], "EN": ["#picture-book", "#friendship", "#sharing"],
       "ZH": ["#图画书", "#友谊", "#分享"], "VI": ["#sách-tranh", "#tình-bạn", "#chia-sẻ"]}),
]
